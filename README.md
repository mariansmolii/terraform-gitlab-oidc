...
| <a name="input_gitlab_oidc_roles"></a> [gitlab_oidc_roles](#input_gitlab_oidc_roles)                                           | A map of roles to create for GitLab OIDC authentication                           | <pre>map(object({<br/> role_name = string<br/> repo_path = string<br/> match_field = optional(string, "sub")<br/> policy_arns = list(string)<br/> max_session_duration = optional(number, 3600)<br/> path = optional(string, "/")<br/> }))</pre> | n/a                    |   yes    |
